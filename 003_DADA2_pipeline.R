# scrip to clean raw data using dada pipeline,
# and put it into a phyloseq object
...
# Next we want to read in the metadata file so we can only read 454 sequences
...
sample_names <- row.names(metadata_in)

# Sort ensures samples are in order
filenames_forward_reads <- sort(paste0(sample_names, ".fastq"))
